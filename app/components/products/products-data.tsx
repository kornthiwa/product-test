...
import { fetchProductsList } from "@/lib/api/fetchers";
...
export function ProductsData() {
  ...
  const { data, isPending, isError, error, isFetching } = useQuery({
    ...
    queryFn: () => fetchProductsList({ page, pageSize }),
  });
        ...
        <table className="w-full min-w-[36rem] text-left text-sm">
          <thead className="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900/50">
            <tr>
              ...
              <th className="px-4 py-3 font-medium text-foreground">ชื่อ</th>
              <th className="px-4 py-3 font-medium text-foreground">ราคา</th>
              <th className="px-4 py-3 font-medium text-foreground">น้ำหนัก</th>
